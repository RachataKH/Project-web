...
<body>
    ...
    <div class="mt-4">
        ...
        <span class="dropdown">
            <button class="btn btn-light btn-sm dropdown-toggle" type="button" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">--ทั้งหมด--</button>
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item btn btn-outline-secondary" href="#">--ทั้งหมด--</a></li>
        ...
        <?php
            for($i=1;$i<=10;$i=$i+1)
            {
                ...
                if (isset($_SESSION['id']) && $_SESSION['role']=='a'){
                    echo "&nbsp;&nbsp;<a href='delete.php?id=$i' class='btn btn-danger btn-sm me-4' style='float: right;'><i class='bi bi-trash-fill'></i></a>";
                    }
                    echo "</td></tr>";
            }
        ?>
